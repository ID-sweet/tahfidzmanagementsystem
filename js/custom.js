...
//       type: 'line',
//       data: {
//         labels: ["Senin", "February", "March", "April", "May", "June", "July"],
//         datasets: [{
...
// DATA TABLES
 // Seleksi elemen input dengan class "dt-column-title" di dalam elemen <th>
        const inputElement = document.querySelector("th[data-dt-column='0'] .dt-column-title input");

        // Tambahkan class baru pada elemen input
        inputElement.classList.add("new-class");

        // Fokus pada elemen input setelah ditambahkan ke DOM
        inputElement.focus();

        // Contoh manipulasi: Mengambil nilai input
        console.log("Nilai input:", inputElement.value);

        // Contoh manipulasi: Menetapkan atribut tambahan
        inputElement.setAttribute("style", "border: 2px solid blue;");

        // Contoh manipulasi: Menambahkan event listener
